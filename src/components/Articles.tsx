              ...
              <div className="w-full max-w-[300px] flex flex-col xl:justify-center items-center relative mx-auto md:mx-0">
                <div className="flex flex-col justify-center text-center">
                  <div className="mb-2 mx-auto">
                    {/* Optional thumbnail:
                    <img src={article.thumbnail} alt={article.title} className="rounded-lg" />
                    */}
                  </div>
                  ...
                  <div className="flex gap-2 flex-wrap mt-2 justify-center">
                    {(article.categories || []).slice(0, 3).map((tag, idx) => (
                      <span
                        key={idx}
                        className="bg-gray-200 dark:bg-gray-700 text-xs font-medium text-gray-800 dark:text-gray-100 px-2 py-1 rounded-full cursor-default"
                        title={`Category: ${tag}`}
                      >
                        {tag}
                      </span>
