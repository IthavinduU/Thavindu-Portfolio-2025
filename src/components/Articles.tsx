...
const articles = [
  {
    ...
    excerpt:
      "සරලව පැහැදිලි කරොත් Microservices Architecture එකක් කියන්නෙ අපි ලග තියන මොකක් හෝ software application එකක් එක පාර සම්පුර්ණ ලොකු application එකක් විදිහට හදන් නැතුව කුඩා කුඩා කොටස් කිහිපයකට වෙන් කරලා",
    date: "Mar 15, 2024",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Exploring upcoming trends and technologies in web development for 2024 and beyond.",
    date: "Mar 10, 2024",
    image:
      "https://www.startdesigns.com/wp-content/uploads/2022/06/Future-of-Web-Development-2022.jpg",
    link: "https://www.blogger.com/blog/post/edit/8514125923631382986/5390360106439228933",
  },
  {
    title: "මොනවද මෙ SOLID Principles කියන්නෙ?",
    excerpt:
      "SOLID Principle කියන්නෙ Object Oriented Programming System වල පාවිච්චි කරන guide lines. Developer කෙනෙක් විදිහට හෝ Software Engineer කෙනෙක් විදිහට මේවා පිලිපදින එක ඉතා වැදගත්.",
    date: "Mar 5, 2024",
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiibbrQWTM58mZCta-ZFMhiRj0f_PPMtmQlQGpPYqfxBCbGQeLk-0WB3Jz-flWuEE6UT8go-a1AmTu7ZHBR3w-gYngMomWJab9cShgy3HYUNc3MB7Y8WADVeZLYuy28wVg-Aay3vBxd-7Fio0fUhJyMQs_R8cUjCQWV023wn1as1ukgm0JIjSVPAw7XeiBV/w610-h376/image%20(1).jpg",
    link: "https://www.blogger.com/blog/post/edit/8514125923631382986/5390360106439228933",
  },
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article) => (
            ...
            >
              ...
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-teal-500/0 via-teal-500/50 to-teal-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
